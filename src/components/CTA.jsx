...
export default function CTA() {
  return (
    <section id="cta" className="relative w-full bg-gray-900 py-20 text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="grid gap-10 lg:grid-cols-3">
          <div className="lg:col-span-2">
            ...
            <p className="mt-3 max-w-2xl text-gray-300">Book a 30‑minute session to map impact, integrations, and timelines. We’ll follow up with a tailored proposal within 48 hours.</p>
          </div>
          <div className="flex items-center gap-3">
            <a href="#contact" className="inline-flex items-center justify-center rounded-full bg-white px-5 py-3 text-gray-900 hover:bg-gray-100 transition-colors">Book a demo</a>
