    ...
    <section className="relative min-h-[92vh] w-full overflow-hidden bg-[var(--brand-bg)]">
        ...
        <div className="mx-auto max-w-7xl px-6 py-5">
          <div className="flex items-center justify-between">
            <a href="#" className="flex items-center gap-2">
              <div className="h-8 w-8 rounded-full bg-gradient-to-br from-[var(--gradient-1)] via-[var(--gradient-2)] to-[var(--gradient-3)]" />
          ...
          {open && (
            <div className="mt-3 flex flex-col gap-2 rounded-lg border border-[var(--brand-border)] p-3 md:hidden bg-[var(--brand-surface)]">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 pt-10 md:pt-16 lg:pt-24">
        <div className="max-w-3xl">
          <span className="inline-flex items-center gap-2 rounded-full border border-[var(--brand-border)] bg-white/70 px-3 py-1 text-xs text-[var(--brand-ink)]/80 backdrop-blur">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-[var(--brand-ink)] sm:text-5xl md:text-6xl">
            Build voice and chat agents that feel effortless
          </h1>
          <p className="mt-4 max-w-2xl text-lg text-[var(--brand-ink-muted)]">
          ...
          <div className="mt-8 flex flex-col items-start gap-3 sm:flex-row">
            <a href="#cta" className="inline-flex items-center justify-center rounded-full bg-[var(--brand-primary)] px-5 py-3 text-white hover:bg-[var(--brand-primary-hover)] transition-colors">
              Get a proposal
            </a>
            <a href="#work" className="inline-flex items-center justify-center rounded-full border border-[var(--brand-border-strong)] bg-[var(--brand-surface)] px-5 py-3 text-[var(--brand-ink)] hover:bg-[var(--brand-surface-2)] transition-colors">
              See our work
            </a>
          </div>
          <div className="mt-8 flex flex-wrap items-center gap-6 text-xs text-[var(--brand-ink-subtle)]">
